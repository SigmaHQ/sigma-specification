...
- All rule descriptions must start with the word `Detects`
...
- All rules must provide a public reference when and if possible.
...
falsepositives:
    ...
    - Administrators or administraor scripts might sometimes generate similar activity
```
